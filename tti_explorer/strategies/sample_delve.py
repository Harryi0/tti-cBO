...
class TTISampleModel:
    ...
    def __call__(self, case, contacts, case_factors):  # noqa: C901
        ...
        # }
        #
        # return output[RETURN_KEYS.reduced_r], output[RETURN_KEYS.tests], output[RETURN_KEYS.man_trace], \
        #        output[RETURN_KEYS.quarantine], output[RETURN_KEYS.base_r]
